      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">
              Experienced system engineer specializing in web development, infrastructure, and cloud solutions.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/skills" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  Skills
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-gray-600 dark:text-gray-400">
                <a href="mailto:contact@example.com" className="hover:text-gray-900 dark:hover:text-white">
                  contact@example.com
                </a>
              </li>
              <li className="text-gray-600 dark:text-gray-400">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-center text-gray-500 dark:text-gray-400">
            &copy; {currentYear} SE Portfolio. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
